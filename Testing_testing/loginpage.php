...
<form method="post" action="" enctype="multipart/form-data" id = "layout">
	...
	<H3>Are you a <p><p></h3>
	<button class = "btn-primary" style = "font-size: 25px;padding: 10px 60px;">Student</button ><p><h3>or</H3> <p><p> <button class = "btn-primary" style = "font-size: 25px;padding: 10px 26px;">College/Client</button>
